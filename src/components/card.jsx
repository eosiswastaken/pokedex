                                ...
                                <div className="h-full w-full flex flex-col items-center justify-between bg-gray-800 back p-1">
                                    <div className="w-full flex justify-between">
                                        <div className="flex flex-wrap justify-between content-center gap-x-1">
                                            <img className="h-[48px] rounded-full" src={pokemonTypes.find(type => type.id === u.types[0])?.image} alt="" />
                                            <img className="h-[48px] rounded-full" src={pokemonTypes.find(type => type.id === u.types[1])?.image} alt="" />
                                            <div className="text-base">#{u.id}</div>
                                        </div>
                                    ...
                                    <div className="w-full flex justify-center">
                                        <div className="flex flex-col justify-center">
                                            {Object.entries(u?.evolvedFrom).map(([id, level]) => (
                                        ...
                                        <div>
                                            <img className="h-[152px]" src={u.image} alt="" />
                                            <div className="text-center text-base">{u.name.en}</div>
                                        </div>
                                        <div className="flex flex-col justify-center">
                                    ...
                                    <div className="w-full flex justify-start text-base">Gen. {u.generation}</div>
                                </div>
                            </div>
                        )}
                    </Popup>
